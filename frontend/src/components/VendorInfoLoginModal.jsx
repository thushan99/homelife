...
const VendorInfoLoginModal = ({ isOpen, onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Separate credentials for vendor info section
    const correctUsername = "VendorAdmin";
    const correctPassword = "Vendor2025";

    if (username !== correctUsername && password !== correctPassword) {
      setError("Invalid login credentials. Please try again.");
      sessionStorage.removeItem("isVendorAdmin");
      return;
    }
    ...
    sessionStorage.setItem("isVendorAdmin", "true");
    onClose();
...
export default VendorInfoLoginModal;
