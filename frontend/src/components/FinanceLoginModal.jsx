...
const FinanceLoginModal = ({ isOpen, onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Separate credentials for finance section
    const correctUsername = "FinanceAdmin";
    const correctPassword = "Finance2025";

    if (username !== correctUsername && password !== correctPassword) {
      setError("Invalid login credentials. Please try again.");
      sessionStorage.removeItem("isFinanceAdmin");
      return;
    }
    ...
    sessionStorage.setItem("isFinanceAdmin", "true");
    onClose();
    navigate("/finance");
  };
...
export default FinanceLoginModal;
