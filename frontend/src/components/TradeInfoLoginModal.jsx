...
const TradeInfoLoginModal = ({ isOpen, onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Separate credentials for trade info section
    const correctUsername = "TradeAdmin";
    const correctPassword = "Trade2025";

    if (username !== correctUsername && password !== correctPassword) {
      setError("Invalid login credentials. Please try again.");
      sessionStorage.removeItem("isTradeAdmin");
      return;
    }
    ...
    sessionStorage.setItem("isTradeAdmin", "true");
    onClose();
    navigate("/trade-info");
  };
...
export default TradeInfoLoginModal;
