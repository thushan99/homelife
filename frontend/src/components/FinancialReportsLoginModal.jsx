...
const FinancialReportsLoginModal = ({ isOpen, onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Separate credentials for financial reports section
    const correctUsername = "ReportsAdmin";
    const correctPassword = "Reports2025";

    if (username !== correctUsername && password !== correctPassword) {
      setError("Invalid login credentials. Please try again.");
      sessionStorage.removeItem("isReportsAdmin");
      return;
    }
    ...
    sessionStorage.setItem("isReportsAdmin", "true");
    onClose();
...
export default FinancialReportsLoginModal;
